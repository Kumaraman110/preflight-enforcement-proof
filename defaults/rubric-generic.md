...
### §1.1 Synchronous blocking in async context
...
### §1.2 Missing CancellationToken propagation
...
### §1.3 Fire-and-forget without observation
...
### §3.2 Catching System.Exception broadly
...
### §5.2 Disposable registered without interface
...
### §6.1 Missing options validation
...
### §6.2 Magic strings for config keys
